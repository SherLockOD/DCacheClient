...
func (st *DelSetReq) resetDefault() {
}

//ReadFrom reads  from _is and put into struct.
func (st *DelSetReq) ReadFrom(_is *codec.Reader) error {
	var err error
	var length int32
	var have bool
	var ty byte
...
func (st *DelSetReq) ReadBlock(_is *codec.Reader, tag byte, require bool) error {
	var err error
	var have bool
	st.resetDefault()
	...
	if !have {
		if require {
			return fmt.Errorf("require DelSetReq, but not exist. tag %d", tag)
		}
		return nil
...
func (st *DelSetReq) WriteTo(_os *codec.Buffer) error {
	var err error
...
func (st *DelSetReq) WriteBlock(_os *codec.Buffer, tag byte) error {
	var err error
