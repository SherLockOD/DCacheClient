...
//GetZsetPosReq strcut implement
type GetZsetPosReq struct {
...
func (st *GetZsetPosReq) resetDefault() {
	st.PositiveOrder = true
	st.IdcSpecified = ""
}

//ReadFrom reads  from _is and put into struct.
func (st *GetZsetPosReq) ReadFrom(_is *codec.Reader) error {
	var err error
	var length int32
	var have bool
	var ty byte
	...
	err = _is.Read_bool(&st.PositiveOrder, 4, true)
	if err != nil {
		return err
	}
...
func (st *GetZsetPosReq) ReadBlock(_is *codec.Reader, tag byte, require bool) error {
	var err error
	var have bool
	st.resetDefault()
	...
	if !have {
		if require {
			return fmt.Errorf("require GetZsetPosReq, but not exist. tag %d", tag)
		}
		return nil
...
func (st *GetZsetPosReq) WriteTo(_os *codec.Buffer) error {
	var err error
	...
	err = _os.Write_bool(st.PositiveOrder, 4)
	if err != nil {
		return err
	}
...
func (st *GetZsetPosReq) WriteBlock(_os *codec.Buffer, tag byte) error {
	var err error
