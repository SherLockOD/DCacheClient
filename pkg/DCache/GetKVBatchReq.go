...
//GetKVBatchReq strcut implement
type GetKVBatchReq struct {
	ModuleName   string   `json:"moduleName"`
	Keys         []string `json:"keys"`
	IdcSpecified string   `json:"idcSpecified"`
}

func (st *GetKVBatchReq) resetDefault() {
	st.IdcSpecified = ""
}

//ReadFrom reads  from _is and put into struct.
func (st *GetKVBatchReq) ReadFrom(_is *codec.Reader) error {
	var err error
	var length int32
	var have bool
	var ty byte
...
func (st *GetKVBatchReq) ReadBlock(_is *codec.Reader, tag byte, require bool) error {
	var err error
	var have bool
	st.resetDefault()
	...
	if !have {
		if require {
			return fmt.Errorf("require GetKVBatchReq, but not exist. tag %d", tag)
		}
		return nil
...
func (st *GetKVBatchReq) WriteTo(_os *codec.Buffer) error {
	var err error
...
func (st *GetKVBatchReq) WriteBlock(_os *codec.Buffer, tag byte) error {
	var err error
