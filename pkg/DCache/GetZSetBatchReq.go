...
//GetZSetBatchReq strcut implement
type GetZSetBatchReq struct {
...
func (st *GetZSetBatchReq) resetDefault() {
	st.IdcSpecified = ""
}

//ReadFrom reads  from _is and put into struct.
func (st *GetZSetBatchReq) ReadFrom(_is *codec.Reader) error {
	var err error
	var length int32
	var have bool
	var ty byte
...
func (st *GetZSetBatchReq) ReadBlock(_is *codec.Reader, tag byte, require bool) error {
	var err error
	var have bool
	st.resetDefault()
	...
	if !have {
		if require {
			return fmt.Errorf("require GetZSetBatchReq, but not exist. tag %d", tag)
		}
		return nil
...
func (st *GetZSetBatchReq) WriteTo(_os *codec.Buffer) error {
	var err error
...
func (st *GetZSetBatchReq) WriteBlock(_os *codec.Buffer, tag byte) error {
	var err error
