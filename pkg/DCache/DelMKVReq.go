...
//DelMKVReq strcut implement
type DelMKVReq struct {
	ModuleName string      `json:"moduleName"`
	MainKey    string      `json:"mainKey"`
	Cond       []Condition `json:"cond"`
}

func (st *DelMKVReq) resetDefault() {
}

//ReadFrom reads  from _is and put into struct.
func (st *DelMKVReq) ReadFrom(_is *codec.Reader) error {
	var err error
	var length int32
	var have bool
	var ty byte
...
func (st *DelMKVReq) ReadBlock(_is *codec.Reader, tag byte, require bool) error {
	var err error
	var have bool
	st.resetDefault()
	...
	if !have {
		if require {
			return fmt.Errorf("require DelMKVReq, but not exist. tag %d", tag)
		}
		return nil
...
func (st *DelMKVReq) WriteTo(_os *codec.Buffer) error {
	var err error
...
func (st *DelMKVReq) WriteBlock(_os *codec.Buffer, tag byte) error {
	var err error
